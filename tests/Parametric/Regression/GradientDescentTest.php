...
use Giuseppe\LearningLibrary\Parametric\Regression\GradientDescent;

class GradientDescentTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers \Giuseppe\LearningLibrary\Parametric\Regression\GradientDescent::predict
     */
    public function testPredict()
    {
        ...
        $gd = new GradientDescent($xs, $ys, $parameters);
